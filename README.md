...
While you're not allowed to use my personal data, you're free to check how things are done technically and it's ok to re-use the techniques in your project.
You don't need to ask for permission for this. If providing my website as open source proved helpful for you, then I'd be happy about a referral though!
